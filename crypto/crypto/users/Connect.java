...
public class Connect extends JPanel
{
    ...
    public Connect(Main mainPage)
    {
        ...
        this.connect  = Main.createCyberButton("Login", ThemeManager.SUCCESS);
        ...
        this.home    = Main.createCyberButton("HOME", ThemeManager.ACCENT);
        this.service = Main.createCyberButton("Service", ThemeManager.ACCENT);
        ...
        {
            Connect.this.mainPage.showView(
                new Contact(Connect.this.mainPage, Connect.this, "CryptoApp — Connexion"),
                "CryptoApp — Contact"
            );
        });
        ...
        {
            Connect.this.mainPage.showView(
                new Service(Connect.this.mainPage, Connect.this, "CryptoApp — Connexion"),
                "CryptoApp — Services"
            );
        });
        ...
        {
            Connect.this.mainPage.showView(
                new About(Connect.this.mainPage, Connect.this, "CryptoApp — Connexion"),
                "CryptoApp — À propos"
            );
        });
