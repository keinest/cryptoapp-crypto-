...
public class Registration extends JPanel
{
    ...
    public Registration(Main main_window)
    {
        ...
        this.submit          = Main.createCyberButton("Submit", ThemeManager.SUCCESS);
        ...
        this.back    = Main.createCyberButton("HOME", ThemeManager.ACCENT);
        this.service = Main.createCyberButton("SERVICES", ThemeManager.ACCENT);
        this.contact = Main.createCyberButton("CONTACT", ThemeManager.ACCENT);
        this.about   = Main.createCyberButton("ABOUT", ThemeManager.ACCENT);
        ...
        this.service.addActionListener(new ActionListener()
        {
            ...
            {
                Registration.this.main_window.showView(
                    new Service(Registration.this.main_window, Registration.this, "CryptoApp — Inscription"),
                    "CryptoApp — Services"
                );
            }
        });
        ...
        this.contact.addActionListener(new ActionListener()
        {
            ...
            {
                Registration.this.main_window.showView(
                    new Contact(Registration.this.main_window, Registration.this, "CryptoApp — Inscription"),
                    "CryptoApp — Contact"
                );
            }
        });
        ...
        this.about.addActionListener(new ActionListener()
        {
            ...
            {
                Registration.this.main_window.showView(
                    new About(Registration.this.main_window, Registration.this, "CryptoApp — Inscription"),
                    "CryptoApp — À propos"
                );
            }
        });
    ...
    public JPanel register()
    {
        ...
        loginLabel.setFont(ThemeManager.FONT_BUTTON);
        ...
        emailLabel.setFont(ThemeManager.FONT_BUTTON);
        ...
        passLabel.setFont(ThemeManager.FONT_BUTTON);
        ...
        confirmLabel.setFont(ThemeManager.FONT_BUTTON);
        ...
        this.submit.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent event)
            {
                ...
                {
                    if(JOptionPane.showConfirmDialog(Registration.this,
                        "<html><div style='font-weight: bold; background-color:rgba(17, 56, 41, 0.08);border-raduis:10px'>Your password is not strong<br>Do you want to continue with ?</div></html>",
                        "Warning" ,JOptionPane.YES_NO_OPTION) != JOptionPane.YES_OPTION)
                    {
                        JOptionPane.showMessageDialog(Registration.this,
                            "<html><div>Check your password and edit!</div></html>" 
                            ,"Request",JOptionPane.INFORMATION_MESSAGE);
                        return;
                    }
                }
        ...
        mainPanel.setBorder(BorderFactory.createCompoundBorder(
            ...
            BorderFactory.createLineBorder(ThemeManager.ACCENT, 3)
        ));
        mainPanel.add(title);
    ...
    {
        this.main_window.showView(panelToRestore, "CryptoApp — Inscription");
    }
}
