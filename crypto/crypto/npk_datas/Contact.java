...
public class Contact extends JPanel
{
    ...
    public Contact(Main main_window, JPanel previousPanel, String previousTitle)
    {
        ...
        this.back.addActionListener(e -> restorePreviousView());

        JPanel navPanel = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        navPanel.setBackground(TEXT_DARK); 
        ...
        cont_scroll.setBackground(TEXT_DARK);
        ...
        this.background.setBackground(TEXT_DARK);
    ...
    private JPanel contact_form()
    {
        ...
        content_panel.setBorder(BorderFactory.createCompoundBorder(
            ...
            "Network Protection Kit (NPK)", TitledBorder.LEFT, TitledBorder.TOP, SUBTITLE_FONT, Color.BLUE)
        ));
        ...
        content_panel.setBackground(TEXT_DARK);
    ...
    private JPanel contact_datas()
    {
        ...
        cont_describe.setForeground(Color.WHITE);
        ...
        coord_data.setForeground(Color.WHITE);
        ...
        op_hour.setForeground(Color.WHITE);
        ...
        h_text.setForeground(Color.WHITE);
        ...
        answer_text.setForeground(Color.WHITE);
        ...
        conf_text.setForeground(Color.WHITE);
        ...
        follow_text.setForeground(Color.WHITE);
        ...
        contact_content.add(Box.createVerticalStrut(30));
        contact_content.setBackground(TEXT_DARK);
