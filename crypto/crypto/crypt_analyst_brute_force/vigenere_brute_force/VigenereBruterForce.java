package crypto.crypt_analyst_brute_force.vigenere_brute_force;
import crypto.Main;
...
public class VigenereBruterForce extends JPanel
{
    ...
    private void styleSpinner(JSpinner spinner) 
    {
        ...
        spinner.setBackground(ThemeManager.BG_CARD);
        ...
        if (editor instanceof JSpinner.DefaultEditor) 
        {
            ...
            textField.setBackground(ThemeManager.BG_CARD);
            textField.setCaretColor(ThemeManager.ACCENT);
        }
    }
    ...
    private JPanel value_field_content()
    {
        ...
        lengthLabel.setFont(ThemeManager.FONT_BUTTON);
