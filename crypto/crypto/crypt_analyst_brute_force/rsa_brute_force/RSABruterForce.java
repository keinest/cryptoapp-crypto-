package crypto.crypt_analyst_brute_force.rsa_brute_force;
import crypto.Main;
...
public class RSABruterForce extends JPanel
{
    ...
    public RSABruterForce(CryptAnalyst cryptanalyst_window)
    {
        ...
        this.start               = Main.createCyberButton("Start Brute Force", ThemeManager.ACCENT);
    ...
    private JProgressBar createCyberProgressBar() 
    {
        ...
        bar.setUI(new javax.swing.plaf.basic.BasicProgressBarUI() 
        {
            ...
            @Override
            protected Color getSelectionForeground() { return ThemeManager.BG_APP; }
        });
